...
fun Context.getWeatherPhotoUrl(photoReference: String): String {
    return AppConstant.PHOTO_1 + photoReference + AppConstant.PHOTO_2
}

fun Activity.showPermissionSettingDialog() {
...
fun Activity.openSettingForPermission() {
    val intent = Intent()
    intent.action = Settings.ACTION_APPLICATION_DETAILS_SETTINGS
    val uri = Uri.fromParts("package", packageName, null)
    intent.data = uri
    startActivityForResult(intent, AppConstant.INTENT_PERMISSION_SETTING)
}
